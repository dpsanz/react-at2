    ...
    return (
        <>
            <main className="bg-black">
                ...
                <div className='flex flex-col items-center'>
                    <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-100 my-8">
                        FILMES EM CARTAZ
                    </h1>
                ...
                <div className='flex flex-col items-center mt-8'>
                    <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-100 mb-8">
